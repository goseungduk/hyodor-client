...
export default {
  ...
  computed: {
    pageCount() { // 게시물 개수는 변화가 있을 때마다 실시간으로 compute 해준다
    ...
    paginatedData() { // 전체 게시물에서 pageSize 만큼 slicing된 posts
  ...
  mounted: function() {
    axios
      .get("http://203.229.206.16:12345/api/v1/" + "board/" + this.no)
      .then(response => {
